...
#ifndef VERILATED_VTEST_MECHANISMS_FPGA_BUENO_CACHE_TFG_H_
#define VERILATED_VTEST_MECHANISMS_FPGA_BUENO_CACHE_TFG_H_  // guard

#include "verilated.h"
class Vtest_mechanisms_fpga_bueno_cache_way__Td_D10_S8;


class Vtest_mechanisms_fpga_bueno__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vtest_mechanisms_fpga_bueno_cache_tfg final : public VerilatedModule {
  public:
    // CELLS
    Vtest_mechanisms_fpga_bueno_cache_way__Td_D10_S8* ways__BRA__0__KET____DOT__way_instance;
    Vtest_mechanisms_fpga_bueno_cache_way__Td_D10_S8* ways__BRA__1__KET____DOT__way_instance;
    Vtest_mechanisms_fpga_bueno_cache_way__Td_D10_S8* ways__BRA__2__KET____DOT__way_instance;
    Vtest_mechanisms_fpga_bueno_cache_way__Td_D10_S8* ways__BRA__3__KET____DOT__way_instance;
    Vtest_mechanisms_fpga_bueno_cache_way__Td_D10_S8* ways__BRA__4__KET____DOT__way_instance;
    ...
    // CONSTRUCTORS
    Vtest_mechanisms_fpga_bueno_cache_tfg(Vtest_mechanisms_fpga_bueno__Syms* symsp, const char* v__name);
    ~Vtest_mechanisms_fpga_bueno_cache_tfg();
    VL_UNCOPYABLE(Vtest_mechanisms_fpga_bueno_cache_tfg);
