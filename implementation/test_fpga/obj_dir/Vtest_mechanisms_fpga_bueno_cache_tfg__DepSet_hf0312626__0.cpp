...
VL_INLINE_OPT void Vtest_mechanisms_fpga_bueno_cache_tfg___ico_sequent__TOP__test_mechanisms_fpga_bueno__patch_inst__patch_cache__0(Vtest_mechanisms_fpga_bueno_cache_tfg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_mechanisms_fpga_bueno__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtest_mechanisms_fpga_bueno_cache_tfg___ico_sequent__TOP__test_mechanisms_fpga_bueno__patch_inst__patch_cache__0\n"); );
    // Init
...
VL_INLINE_OPT void Vtest_mechanisms_fpga_bueno_cache_tfg___nba_sequent__TOP__test_mechanisms_fpga_bueno__patch_inst__patch_cache__0(Vtest_mechanisms_fpga_bueno_cache_tfg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_mechanisms_fpga_bueno__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtest_mechanisms_fpga_bueno_cache_tfg___nba_sequent__TOP__test_mechanisms_fpga_bueno__patch_inst__patch_cache__0\n"); );
    // Body
...
VL_INLINE_OPT void Vtest_mechanisms_fpga_bueno_cache_tfg___nba_sequent__TOP__test_mechanisms_fpga_bueno__patch_inst__patch_cache__1(Vtest_mechanisms_fpga_bueno_cache_tfg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_mechanisms_fpga_bueno__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtest_mechanisms_fpga_bueno_cache_tfg___nba_sequent__TOP__test_mechanisms_fpga_bueno__patch_inst__patch_cache__1\n"); );
    // Init
    CData/*0:0*/ __PVT__enable_write;
    __PVT__enable_write = 0;
    CData/*2:0*/ __PVT__way_to_write;
...
VL_INLINE_OPT void Vtest_mechanisms_fpga_bueno_cache_tfg___nba_comb__TOP__test_mechanisms_fpga_bueno__patch_inst__patch_cache__0(Vtest_mechanisms_fpga_bueno_cache_tfg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_mechanisms_fpga_bueno__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtest_mechanisms_fpga_bueno_cache_tfg___nba_comb__TOP__test_mechanisms_fpga_bueno__patch_inst__patch_cache__0\n"); );
    // Init
    CData/*0:0*/ hit_logic_inst__DOT____Vlvbound_h725b0b14__0;
    hit_logic_inst__DOT____Vlvbound_h725b0b14__0 = 0;
    // Body
