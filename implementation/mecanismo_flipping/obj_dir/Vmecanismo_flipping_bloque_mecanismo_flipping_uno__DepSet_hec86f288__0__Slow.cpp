...
VL_ATTR_COLD void Vmecanismo_flipping_bloque_mecanismo_flipping_uno___ctor_var_reset(Vmecanismo_flipping_bloque_mecanismo_flipping_uno* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmecanismo_flipping_bloque__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vmecanismo_flipping_bloque_mecanismo_flipping_uno___ctor_var_reset\n"); );
    // Body
