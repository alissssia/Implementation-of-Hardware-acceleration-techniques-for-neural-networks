...
VL_ATTR_COLD void Vtop_patching_16_bram__D100_Wd___ctor_var_reset(Vtop_patching_16_bram__D100_Wd* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop_patching_16__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_patching_16_bram__D100_Wd___ctor_var_reset\n"); );
    // Body
