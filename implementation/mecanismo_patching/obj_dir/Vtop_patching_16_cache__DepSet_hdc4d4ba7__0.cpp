...
#include "Vtop_patching_16_cache.h"
...
VL_INLINE_OPT void Vtop_patching_16_cache___ico_sequent__TOP__top_patching_16__patch_cache__0(Vtop_patching_16_cache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop_patching_16__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_patching_16_cache___ico_sequent__TOP__top_patching_16__patch_cache__0\n"); );
    // Init
...
VL_INLINE_OPT void Vtop_patching_16_cache___nba_sequent__TOP__top_patching_16__patch_cache__0(Vtop_patching_16_cache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop_patching_16__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_patching_16_cache___nba_sequent__TOP__top_patching_16__patch_cache__0\n"); );
    // Body
...
VL_INLINE_OPT void Vtop_patching_16_cache___nba_sequent__TOP__top_patching_16__patch_cache__1(Vtop_patching_16_cache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop_patching_16__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_patching_16_cache___nba_sequent__TOP__top_patching_16__patch_cache__1\n"); );
    // Init
    CData/*2:0*/ __PVT__way_to_write;
    __PVT__way_to_write = 0;
    CData/*0:0*/ __PVT__enable_write;
...
VL_INLINE_OPT void Vtop_patching_16_cache___nba_comb__TOP__top_patching_16__patch_cache__0(Vtop_patching_16_cache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop_patching_16__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_patching_16_cache___nba_comb__TOP__top_patching_16__patch_cache__0\n"); );
    // Init
    CData/*0:0*/ hit_logic_inst__DOT____Vlvbound_h725b0b14__0;
    hit_logic_inst__DOT____Vlvbound_h725b0b14__0 = 0;
    // Body
