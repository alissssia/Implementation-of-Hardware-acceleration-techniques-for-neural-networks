...
#ifndef VERILATED_VTOP_PATCHING_UNO_CACHE_TFG_H_
#define VERILATED_VTOP_PATCHING_UNO_CACHE_TFG_H_  // guard

#include "verilated.h"
class Vtop_patching_uno_cache_way__Td_D10_S8;


class Vtop_patching_uno__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vtop_patching_uno_cache_tfg final : public VerilatedModule {
  public:
    // CELLS
    Vtop_patching_uno_cache_way__Td_D10_S8* ways__BRA__0__KET____DOT__way_instance;
    Vtop_patching_uno_cache_way__Td_D10_S8* ways__BRA__1__KET____DOT__way_instance;
    Vtop_patching_uno_cache_way__Td_D10_S8* ways__BRA__2__KET____DOT__way_instance;
    Vtop_patching_uno_cache_way__Td_D10_S8* ways__BRA__3__KET____DOT__way_instance;
    Vtop_patching_uno_cache_way__Td_D10_S8* ways__BRA__4__KET____DOT__way_instance;
    ...
    // CONSTRUCTORS
    Vtop_patching_uno_cache_tfg(Vtop_patching_uno__Syms* symsp, const char* v__name);
    ~Vtop_patching_uno_cache_tfg();
    VL_UNCOPYABLE(Vtop_patching_uno_cache_tfg);
