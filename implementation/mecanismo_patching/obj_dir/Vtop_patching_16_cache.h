...
#ifndef VERILATED_VTOP_PATCHING_16_CACHE_H_
#define VERILATED_VTOP_PATCHING_16_CACHE_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_patching_16_cache final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vtop_patching_16_cache(Vtop_patching_16__Syms* symsp, const char* v__name);
    ~Vtop_patching_16_cache();
    VL_UNCOPYABLE(Vtop_patching_16_cache);
