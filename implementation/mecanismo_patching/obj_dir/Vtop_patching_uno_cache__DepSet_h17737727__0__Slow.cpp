...
VL_ATTR_COLD void Vtop_patching_uno_cache___stl_sequent__TOP__top_patching_uno__patch_cache__0(Vtop_patching_uno_cache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop_patching_uno__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_patching_uno_cache___stl_sequent__TOP__top_patching_uno__patch_cache__0\n"); );
    // Init
