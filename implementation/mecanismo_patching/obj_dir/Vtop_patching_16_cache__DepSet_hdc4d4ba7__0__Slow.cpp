...
VL_ATTR_COLD void Vtop_patching_16_cache___stl_sequent__TOP__top_patching_16__patch_cache__0(Vtop_patching_16_cache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop_patching_16__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_patching_16_cache___stl_sequent__TOP__top_patching_16__patch_cache__0\n"); );
    // Init
