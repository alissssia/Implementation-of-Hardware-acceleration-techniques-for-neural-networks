...
extern const VlUnpacked<CData/*2:0*/, 128> Vtop_patching_16__ConstPool__TABLE_he4111221_0;
extern const VlUnpacked<CData/*0:0*/, 128> Vtop_patching_16__ConstPool__TABLE_hb9d54fc4_0;
extern const VlUnpacked<CData/*0:0*/, 128> Vtop_patching_16__ConstPool__TABLE_h599c0850_0;
extern const VlUnpacked<CData/*0:0*/, 128> Vtop_patching_16__ConstPool__TABLE_h08e7034b_0;

VL_INLINE_OPT void Vtop_patching_16_cache_tfg___ico_sequent__TOP__top_patching_16__patch_cache__0(Vtop_patching_16_cache_tfg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop_patching_16__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_patching_16_cache_tfg___ico_sequent__TOP__top_patching_16__patch_cache__0\n"); );
    // Init
    ...
    vlSelf->__PVT__next_state = Vtop_patching_16__ConstPool__TABLE_he4111221_0
        [__Vtableidx1];
    vlSelf->__PVT__enable_read = Vtop_patching_16__ConstPool__TABLE_hb9d54fc4_0
        [__Vtableidx1];
    __PVT__enable_write = Vtop_patching_16__ConstPool__TABLE_h599c0850_0
        [__Vtableidx1];
    vlSelf->__PVT__enable_write_valid = Vtop_patching_16__ConstPool__TABLE_h599c0850_0
        [__Vtableidx1];
    vlSelf->__PVT__enable_ram_output = Vtop_patching_16__ConstPool__TABLE_h08e7034b_0
        [__Vtableidx1];
    __PVT__enable_write_way_bit = Vtop_patching_16__ConstPool__TABLE_h599c0850_0
        [__Vtableidx1];
...
VL_INLINE_OPT void Vtop_patching_16_cache_tfg___nba_sequent__TOP__top_patching_16__patch_cache__0(Vtop_patching_16_cache_tfg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop_patching_16__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_patching_16_cache_tfg___nba_sequent__TOP__top_patching_16__patch_cache__0\n"); );
    // Body
    vlSelf->__PVT__tag_out[0U] = vlSymsp->TOP__top_patching_16__patch_cache__ways__BRA__0__KET____DOT__way_instance__tag_bram.__PVT__data_out;
    vlSelf->__PVT__tag_out[1U] = vlSymsp->TOP__top_patching_16__patch_cache__ways__BRA__1__KET____DOT__way_instance__tag_bram.__PVT__data_out;
    vlSelf->__PVT__tag_out[2U] = vlSymsp->TOP__top_patching_16__patch_cache__ways__BRA__2__KET____DOT__way_instance__tag_bram.__PVT__data_out;
    vlSelf->__PVT__tag_out[3U] = vlSymsp->TOP__top_patching_16__patch_cache__ways__BRA__3__KET____DOT__way_instance__tag_bram.__PVT__data_out;
    vlSelf->__PVT__tag_out[4U] = vlSymsp->TOP__top_patching_16__patch_cache__ways__BRA__4__KET____DOT__way_instance__tag_bram.__PVT__data_out;
...
VL_INLINE_OPT void Vtop_patching_16_cache_tfg___nba_sequent__TOP__top_patching_16__patch_cache__1(Vtop_patching_16_cache_tfg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop_patching_16__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_patching_16_cache_tfg___nba_sequent__TOP__top_patching_16__patch_cache__1\n"); );
    // Init
    CData/*0:0*/ __PVT__enable_write;
    __PVT__enable_write = 0;
    CData/*2:0*/ __PVT__way_to_write;
...
VL_INLINE_OPT void Vtop_patching_16_cache_tfg___nba_comb__TOP__top_patching_16__patch_cache__0(Vtop_patching_16_cache_tfg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop_patching_16__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_patching_16_cache_tfg___nba_comb__TOP__top_patching_16__patch_cache__0\n"); );
    // Init
    CData/*0:0*/ hit_logic_inst__DOT____Vlvbound_h725b0b14__0;
    hit_logic_inst__DOT____Vlvbound_h725b0b14__0 = 0;
    // Body
