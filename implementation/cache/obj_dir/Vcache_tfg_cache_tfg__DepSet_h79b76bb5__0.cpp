...
VL_INLINE_OPT void Vcache_tfg_cache_tfg___ico_sequent__TOP__cache_tfg__0(Vcache_tfg_cache_tfg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcache_tfg__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vcache_tfg_cache_tfg___ico_sequent__TOP__cache_tfg__0\n"); );
    // Init
    ...
    vlSelf->valid = (0U != (0x1fU & (~ vlSelf->__PVT__valid_bits_array
                                     [(0xffU & vlSymsp->TOP.address)])));
    ...
    __Vtableidx1 = (((IData)(vlSelf->valid) << 6U) 
                    | (((IData)(vlSymsp->TOP.read_write) 
                        << 5U) | (((IData)(vlSymsp->TOP.request) 
                                   << 4U) | (((IData)(vlSymsp->TOP.reset) 
                                              << 3U) 
                                             | (IData)(vlSelf->__PVT__state)))));
    vlSelf->__PVT__next_state = Vcache_tfg__ConstPool__TABLE_he4111221_0
        [__Vtableidx1];
    vlSelf->__PVT__enable_read = Vcache_tfg__ConstPool__TABLE_hb9d54fc4_0
        [__Vtableidx1];
    __PVT__enable_write = Vcache_tfg__ConstPool__TABLE_h599c0850_0
        [__Vtableidx1];
    vlSelf->__PVT__enable_write_valid = Vcache_tfg__ConstPool__TABLE_h599c0850_0
        [__Vtableidx1];
    vlSelf->__PVT__enable_ram_output = Vcache_tfg__ConstPool__TABLE_h08e7034b_0
        [__Vtableidx1];
    __PVT__enable_write_way_bit = Vcache_tfg__ConstPool__TABLE_h599c0850_0
        [__Vtableidx1];
...
VL_INLINE_OPT void Vcache_tfg_cache_tfg___nba_sequent__TOP__cache_tfg__0(Vcache_tfg_cache_tfg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcache_tfg__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vcache_tfg_cache_tfg___nba_sequent__TOP__cache_tfg__0\n"); );
    // Body
    vlSelf->__PVT__tag_out[0U] = vlSymsp->TOP__cache_tfg__ways__BRA__0__KET____DOT__way_instance__tag_bram.__PVT__data_out;
    vlSelf->__PVT__tag_out[1U] = vlSymsp->TOP__cache_tfg__ways__BRA__1__KET____DOT__way_instance__tag_bram.__PVT__data_out;
    vlSelf->__PVT__tag_out[2U] = vlSymsp->TOP__cache_tfg__ways__BRA__2__KET____DOT__way_instance__tag_bram.__PVT__data_out;
    vlSelf->__PVT__tag_out[3U] = vlSymsp->TOP__cache_tfg__ways__BRA__3__KET____DOT__way_instance__tag_bram.__PVT__data_out;
    vlSelf->__PVT__tag_out[4U] = vlSymsp->TOP__cache_tfg__ways__BRA__4__KET____DOT__way_instance__tag_bram.__PVT__data_out;
...
VL_INLINE_OPT void Vcache_tfg_cache_tfg___nba_sequent__TOP__cache_tfg__1(Vcache_tfg_cache_tfg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcache_tfg__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vcache_tfg_cache_tfg___nba_sequent__TOP__cache_tfg__1\n"); );
    // Init
    CData/*2:0*/ __PVT__way_to_write;
    __PVT__way_to_write = 0;
    CData/*0:0*/ __PVT__enable_write;
...
VL_INLINE_OPT void Vcache_tfg_cache_tfg___nba_comb__TOP__cache_tfg__0(Vcache_tfg_cache_tfg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcache_tfg__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vcache_tfg_cache_tfg___nba_comb__TOP__cache_tfg__0\n"); );
    // Init
    CData/*0:0*/ hit_logic_inst__DOT____Vlvbound_h725b0b14__0;
    hit_logic_inst__DOT____Vlvbound_h725b0b14__0 = 0;
    // Body
