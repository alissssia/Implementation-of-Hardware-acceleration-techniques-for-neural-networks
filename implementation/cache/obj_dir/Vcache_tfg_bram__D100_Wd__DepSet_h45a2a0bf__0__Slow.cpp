...
VL_ATTR_COLD void Vcache_tfg_bram__D100_Wd___ctor_var_reset(Vcache_tfg_bram__D100_Wd* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcache_tfg__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vcache_tfg_bram__D100_Wd___ctor_var_reset\n"); );
    // Body
