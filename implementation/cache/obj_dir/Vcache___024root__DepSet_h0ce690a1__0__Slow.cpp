...
VL_ATTR_COLD void Vcache___024root___stl_sequent__TOP__0(Vcache___024root* vlSelf);
...
VL_ATTR_COLD void Vcache___024root___eval_stl(Vcache___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
        Vcache___024root___stl_sequent__TOP__0(vlSelf);
        Vcache_cache___stl_sequent__TOP__cache__0((&vlSymsp->TOP__cache));
...
VL_ATTR_COLD void Vcache___024root___stl_sequent__TOP__0(Vcache___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcache__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcache___024root___stl_sequent__TOP__0\n"); );
    // Body
