...
#ifndef VERILATED_VCACHE_TFG_CACHE_TFG_H_
#define VERILATED_VCACHE_TFG_CACHE_TFG_H_  // guard

#include "verilated.h"
class Vcache_tfg_cache_way__Td_D10_S8;


class Vcache_tfg__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vcache_tfg_cache_tfg final : public VerilatedModule {
  public:
    // CELLS
    Vcache_tfg_cache_way__Td_D10_S8* ways__BRA__0__KET____DOT__way_instance;
    Vcache_tfg_cache_way__Td_D10_S8* ways__BRA__1__KET____DOT__way_instance;
    Vcache_tfg_cache_way__Td_D10_S8* ways__BRA__2__KET____DOT__way_instance;
    Vcache_tfg_cache_way__Td_D10_S8* ways__BRA__3__KET____DOT__way_instance;
    Vcache_tfg_cache_way__Td_D10_S8* ways__BRA__4__KET____DOT__way_instance;
    ...
    // CONSTRUCTORS
    Vcache_tfg_cache_tfg(Vcache_tfg__Syms* symsp, const char* v__name);
    ~Vcache_tfg_cache_tfg();
    VL_UNCOPYABLE(Vcache_tfg_cache_tfg);
