...
VL_ATTR_COLD void Vcache_cache_way__Td_D10_S8___ctor_var_reset(Vcache_cache_way__Td_D10_S8* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcache__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vcache_cache_way__Td_D10_S8___ctor_var_reset\n"); );
    // Body
