...
VL_ATTR_COLD void Vcache_bram__D100_W5___ctor_var_reset(Vcache_bram__D100_W5* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcache__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vcache_bram__D100_W5___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__data_in = VL_RAND_RESET_I(5);
    vlSelf->__PVT__data_out = VL_RAND_RESET_I(5);
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->ram[__Vi0] = VL_RAND_RESET_I(5);
    }
    vlSelf->__VdlyVal__ram__v0 = VL_RAND_RESET_I(5);
    vlSelf->__VdlyDim0__ram__v0 = VL_RAND_RESET_I(8);
